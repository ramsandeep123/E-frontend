...
import { SearchViceProducts } from '@/store/action'
...
const SearchButton = () => {
  ...
  const searchData = useSelector((state: any) => state?.ecomm?.searchState || [])
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      const response = await dispatch(SearchViceProducts(debounced))
      setData(response)
    }
        ...
        <CommandList>
          ...
          {isPending ? (
            ...
            data?.map((group) => (
              ...
              //             handleSelect(() =>
              //               router.push(
              //                 `/${item.storeId}/${item.slug}?productId=${item._id}`,
              //               ),
              //             )
              //           }
              //         >
