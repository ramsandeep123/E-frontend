      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="">
            ...
            <p>
              Explore our curated collection of top-quality products, designed to bring style, comfort, and functionality to your everyday life. From the latest trends in fashion to innovative tech gadgets, we are dedicated to providing an exceptional shopping experience.
            </p>
          </div>
